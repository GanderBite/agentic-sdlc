...
// ---------------------------------------------------------------------------
function buildTestApp(hasherOverride) {
    const app = new Hono();
...
describe('auth.constant-time', () => {
    ...
    beforeEach(async () => {
        ...
        const verifySpy = vi.fn((hash, plain) => defaultPasswordHasher.verify(hash, plain));
        spiedHasher = {
...
//# sourceMappingURL=auth.constant-time.test.js.map