...
<job>
Read the enriched brief in `<context name="enriched_brief">`, plus `docs/INTEL.md`, `.planning/intel/modules.json`, `.planning/intel/build-graph.json`, `.planning/intel/hot-files.md`, `.claude/skills/INDEX.json`, `.planning/estimation_priors.json`, and the current `docs/ARCHITECTURE.md`.
...
<procedure>
1. For each acceptance bullet in `{{enriched_brief.acceptance_bullets}}`, propose 1..N tasks per §5.1.1.
