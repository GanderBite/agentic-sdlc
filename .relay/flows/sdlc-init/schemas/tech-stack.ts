...
export const TechStackSchema = z.object({
  ...
  languages: z
    .array(z.string())
    .min(1)
    .describe('Primary languages chosen for the project.'),
  runtime: z
    .string()
    .describe('Runtime version pin, e.g. "node@22", "python@3.13", "go@1.23". One value, no "either/or".'),
  package_manager: z
    .string()
  ...
  skills_to_author: z
    .array(z.string())
    .describe('Skill package names the next step must author. Deduplicated; excludes existing process skills.'),
});
